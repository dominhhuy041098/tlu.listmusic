    ...
    <div class="col-lg-12 col-md-12 col-sm12 col-xs-12">
        ...
        <table class="table table-hover">
            ...
            <?php
					...
					else
					{
						...
						$query_pg="SELECT COUNT(id) FROM tblchude";
                    ...
                    $query="SELECT * FROM tblchude ORDER BY ordernum DESC LIMIT {$start},{$limit} ";
        ...
        <?php 
			...
			if($per_page > 1)
			{
				...
				if($current_page !=1)
				{
					echo "<li><a href='list_cd.php?s=".($start - $limit)."&p={$per_page}'>Back</a></li>";
				}
				...
				{ 
					if($i != $current_page)
					{
						echo "<li><a href='list_cd.php?s=".($limit *($i - 1))."&p={$per_page}'>{$i}</a></li>";
					}
					else
					{
				...
				{
					echo "<li><a href='list_cd.php?s=".($start + $limit)."&p={$per_page}'>Next</a></li>";	
				}
			}
			echo "</ul>";
		?>		
