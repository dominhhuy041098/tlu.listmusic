    ...
    <div class="col-lg-12 col-md-12 col-sm12 col-xs-12">
            ...
            <tbody>
                <?php
					...
					else
					{
						...
						$query_pg="SELECT COUNT(id) FROM tblvideo";
                    ...
                    $query="SELECT * FROM tblvideo ORDER BY id DESC LIMIT {$start},{$limit} ";
        ...
        <?php 
			...
			if($per_page > 1)
			{
				...
				if($current_page !=1)
				{
					echo "<li><a href='list_vd.php?s=".($start - $limit)."&p={$per_page}'>Back</a></li>";
				}
				...
				{ 
					if($i != $current_page)
					{
						echo "<li><a href='list_vd.php?s=".($limit *($i - 1))."&p={$per_page}'>{$i}</a></li>";
					}
					else
					{
				...
				{
					echo "<li><a href='list_vd.php?s=".($start + $limit)."&p={$per_page}'>Next</a></li>";	
				}
			}
			echo "</ul>";
		?>		
