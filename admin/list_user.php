			...
			<tbody>
				<?php
					...
					<tr>
						...
						<td><a href="reset_user.php?id=<?php echo $user['id']; ?>"><img width="16" src="../image/reset.png"></a></td>					
						<td><a href="edit_user.php?id=<?php echo $user['id']; ?>"><img width="16" src="../image/edit.png"></a></td>						
						<td><a href="delete_user.php?id=<?php echo $user['id'];?>" onclick="return confirm('Bạn có thực sự muốn xóa không');"><img width="16" src="../image/delete.png"></a></td>
					</tr>
					<?php		
					}
